...
fn test_list_with_pattern() {
    let args = <Args as Parser>::try_parse_from(["test", "list", "-p", "hello"]).unwrap();
    match args.command {
...
#[test]
fn test_list_alias() {
    let args = <Args as Parser>::try_parse_from(["test", "l", "-p", "foo"]).unwrap();
    match args.command {
...
fn test_migrate_defaults() {
    let args = <Args as Parser>::try_parse_from(["test", "migrate"]).unwrap();
    match args.command {
...
fn test_migrate_with_pattern() {
    let args = <Args as Parser>::try_parse_from(["test", "migrate", "-p", "hello"]).unwrap();
    match args.command {
...
fn test_migrate_alias() {
    let args = <Args as Parser>::try_parse_from(["test", "m", "-p", "foo"]).unwrap();
    match args.command {
...
fn test_rebase_defaults() {
    let args = <Args as Parser>::try_parse_from(["test", "rebase"]).unwrap();
    match args.command {
